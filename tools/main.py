...
def restore_exist_labels(label_path):
    ...
    start_index = 0
    if os.path.exists('/workspace/mnt/group/ocr/chenmingxi/ocr_generator/tmp_labels.txt'):
        start_index = len(utils.load_chars('/workspace/mnt/group/ocr/chenmingxi/ocr_generator/tmp_labels.txt'))
...
if __name__ == "__main__":
    ...
    tmp_label_path = os.path.join('/workspace/mnt/group/ocr/chenmingxi/ocr_generator/', 'tmp_labels.txt')
    label_path = os.path.join('/workspace/mnt/group/ocr/chenmingxi/ocr_generator/', 'labels.txt')
